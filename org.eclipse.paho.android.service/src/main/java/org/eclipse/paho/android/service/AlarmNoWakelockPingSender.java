 ...
 * @see MqttPingSender
 */
class AlarmNoWakelockPingSender implements MqttPingSender {
	...
	private AlarmNoWakelockPingSender that;
	private PendingIntent pendingIntent;
	private volatile boolean hasStarted = false;

	public AlarmNoWakelockPingSender(MqttService service) {
		if (service == null) {
	...
	public void schedule(long delayInMilliseconds) {
        ...
        if(Build.VERSION.SDK_INT >= 23){
			...
			alarmManager.setExactAndAllowWhileIdle(AlarmManager.RTC, nextAlarmInMilliseconds,
					pendingIntent);
		} else if (Build.VERSION.SDK_INT >= 19) {
			Log.d(TAG, "Alarm scheule using setExact, delay: " + delayInMilliseconds);
			alarmManager.setExact(AlarmManager.RTC, nextAlarmInMilliseconds,
					pendingIntent);
		} else {
			alarmManager.set(AlarmManager.RTC, nextAlarmInMilliseconds,
					pendingIntent);
		}
	}
